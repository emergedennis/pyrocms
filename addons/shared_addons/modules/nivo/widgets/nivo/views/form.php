<ol>
	<fieldset>
		...
		<li class="<?php echo alternator('even', ''); ?>">
			<label for="slider_id">Choose Image Category</label>
			<?php echo form_dropdown('slider_id', $select_slider, $options['slider_id']); ?>
		</li>

		<li class="<?php echo alternator('even', ''); ?>">
			<label for="theme">Theme</label>
			<?php echo form_dropdown('theme', array('none' => 'None', 'default' => 'Default', 'dark' => 'Dark', 'light' => 'Light', 'bar' => 'Bar',), $options['theme']); ?>
		</li>
