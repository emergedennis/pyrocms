...
class Admin_Categories extends Admin_Controller {
	...
	public function index()
	{
		...
		$total_rows = $this->casestudies_categories_m->count_all();
		$pagination = create_pagination('admin/casestudies/categories/index', $total_rows, NULL, 5);
			
		// Using this data, get the relevant results
		$categories = $this->casestudies_categories_m->order_by('title')->limit($pagination['limit'])->get_all();
	...
	public function create()
	{
		...
		{
			$this->casestudies_categories_m->insert($_POST)
			...
			redirect('admin/casestudies/categories');
		}
	...
	{	
		// Get the category
		$category = $this->casestudies_categories_m->get($id);
		
		// ID specified?
		$category or redirect('admin/casestudies/categories/index');
		
		// Validate the results
		if ($this->form_validation->run())
		{		
			$this->casestudies_categories_m->update($id, $_POST)
			...
			redirect('admin/casestudies/categories/index');
		}
	...
	{	
		...
		if (!empty($id_array))
		{
			...
			{
				if ($this->casestudies_categories_m->delete($id))
				{
					$deleted++;
				}
				else
	...
	{
		if ($this->casestudies_categories_m->check_title($title))
		{
	...
	public function create_ajax()
	{
		...
		if ($this->form_validation->run())
		{
			$id = $this->casestudies_categories_m->insert_ajax($_POST);
