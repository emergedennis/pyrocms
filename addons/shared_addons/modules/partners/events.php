...
class Events_Partners {
    ...
    public function __construct()
    {
		...
		// To execute the "run" method below you would use: Events::trigger('partners_event');
		// in any php file within PyroCMS, even another module.
		Events::register('partners_event', array($this, 'run'));
    }
    ...
    public function run()
    {
        ...
        $this->ci->partners_m->limit(5)->get_all();
    }
